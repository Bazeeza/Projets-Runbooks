# Travail Pratique Final – AWS – Architecture réseau + groupes de sécurité (EC2-Mattermost)

**Auteur / But et schéma de planification**

| Élément       | Contenu |
|-------------|---------|
| **Référent**  | Présentation et documentation de l’instance **EC2-Mattermost** hébergée sur **AWS** (Compte 1 / **N. Virginia – us-east-1**). |
| **Émetteur**  | **Abdul-Bariu, Freddy, Abdul-Majid et Aran** |
| **Message**   | Documenter les résultats de l’architecture réseau (**VPC / Subnet / IP**) et les **règles de pare-feu (Security Groups)** associées au serveur Mattermost. |
| **Récepteur** | M. Jérémy Massinon |
| **Canal**     | Dépôt GitLab |
| **Code**      | Français |
| **Références** | [AWS EC2](https://docs.aws.amazon.com/fr_fr/ec2/) · [Mattermost Docs](https://docs.mattermost.com/) |

---

## 1) Architecture réseautique et configuration de base (EC2-Mattermost)

### 1.1 Identité / hébergement
- **Fournisseur :** AWS  
- **Service :** EC2  
- **Nom instance :** `EC2-Mattermost`  
- **ID instance :** `i-0acc90a4d67f9971f`  
...
- **Adresse IPv4 privée :** `10.0.1.108`  
- **Adresse IPv4 publique (Elastic IP) :** `50.19.216.38`  
- **DNS privé :** `ip-10-0-1-108.ec2.internal`  
...
### 1.5 Service hébergé
- **Service :** Mattermost (service web)
...
![cap-ec2-mattermost](https://i.postimg.cc/0jXmK5Ls/Screenshot-2025-12-15-at-3-58-07-PM-1.png)

---

## 3) Groupes de sécurité (pare-feu) – EC2-Mattermost
...
| Services-Compte1 (sg-019d883c76e93f329) | 8065 | TCP | 0.0.0.0/0 | Port applicatif Mattermost exposé (indiqué “Mattermost”). |
...
![cap-sg-mattermost](https://i.postimg.cc/FKbLgV2k/Screenshot-2025-12-15-at-5-40-41-PM.png)
